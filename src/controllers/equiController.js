/**
 * EQUI (Equipment) — CRUD Controller
 * SAP OData conventions for PM_EQUIPMENT_SRV
 */
...
const PK = 'EQUNR';
const COLUMNS = [
  'EQUNR', 'EQTXT', 'TPLNR', 'IWERK', 'KOSTL', 'BUKRS',
  'ERDAT', 'AEDAT', 'EQART', 'SERGE', 'BAUJJ', 'ANSWT', 'WAERS',
];
